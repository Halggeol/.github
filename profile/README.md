...
<div align="center">
  ...
  <p>📈 재테크를 위한 금융상품 비교 추천 서비스 📈</p>
</div>

<br/>

<div align="center">
  <img width="700" alt="image" src="https://github.com/user-attachments/assets/106b2d65-b3bc-47c2-bde8-3ba36d58fe7c" />
...
1. **2030의 이어지지 않는 금융 행위:** 
   ...
   - '관심이 없어서', '설명이 부족하거나 복잡해서' 등 다양한 이유로 금융상품에 가입하지 않음.

2. **기존 금융상품 추천 서비스의 한계:** 
   - '예금 통장 비교'와 같이 하나의 금융 상품 유형에 치중한 서비스들이 대다수.
   - 다양한 상품 유형을 탐색하고 싶은 사용자는 아쉬움을 느낌.

👉 후회 경험으로 상품 가입을 유도하면 어떨까?

**그때 할걸**은 위 문제를 해결하기 위해 **각 상품 유형별 사용자 맞춤형 회고 기반 인사이트**와 **다양한 유형의 금융상품 정보**를 제공하는 금융상품 추천 서비스입니다.
...
- [화면 설계서](https://www.figma.com/design/EZqHFeUyP3BETLvhcbmQTI/%EA%B7%B8%EB%95%8C-%ED%95%A0%EA%B1%B8?node-id=2389-3695&t=mV8yAFnKVvb1Pp4S-4)
